...
<div id="dic" class="popup hide"><div class="closer" onclick="javascript:_class('dic', 'hide')"></div><a href="javascript:_class('dic', 'hide')" class="close">X</a>
	<div class="pole"><h2>Dictionaries</h2>
       	<ul>
			<li><a href="DoubleHashing.html">Double Hashing</a></li>
			<li><a href="LinearProbing.html">Linear Probing</a></li>
			<li><a href="LinearHashing.html">Linear Hashing</a></li>
			<li><a href="SeparateChaining.html">SeparateChaining</a></li>
			<li><a href="ExtendibleHashing.html">Extendible Hashing</a></li>
			<li><span>BISEH</span></li>
        </ul>
	</div>
</div>
